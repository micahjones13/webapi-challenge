...
- [x] Mention two parts of Express that you learned about this week.
    ...
    - 1) express routing. This is when you break apart your server into sub-applications for certain URL's
    - 2) express Middleware. Middleware are the functions that you wrtie to do certain things to certain requests. 

- [x] Describe Middleware?

    - Middleware intercepts requests and runs the middleware function over it before it returns anything. This can edit data or check for data. Very useful in verifying incoming data

- [x] Describe a Resource?

    - A resource is any info that a database hold. In the case of this project, actions, projects, and all that they contain are resources.

- [x] What can the API return to help clients know if a request was successful?
    
    - Any status within the 200 range represents a succesful request.

- [x] How can we partition our application into sub-applications?

    - Using separate routers helps divide up the content into sub-applications. In this project, I have two sub-applications in actions_router.js and projects_router.js.
